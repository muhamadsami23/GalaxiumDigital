...
export const metadata: Metadata = {
  ...
  // ✅ Open Graph for Google / Facebook Preview
  openGraph: {
    title: "Galaxium Digital | Web, Software & Marketing Experts",
    description:
      "We design, build, and grow digital experiences that deliver real results. Explore Galaxium Digital's web, software, and marketing services today.",
    url: "https://galaxiumdigital.app",
    siteName: "Galaxium Digital",
    images: [
      {

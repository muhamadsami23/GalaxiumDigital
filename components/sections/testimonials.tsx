...
//   // },
//   {
//     quote: "Delivered exactly what we needed with creativity and precision — the process was smooth from start to finish..",
//     name: "Shagufta Salman",
//     org: "Mind Mechanics",
...
const testimonials = [
  {
    quote:
      "Delivered exactly what we needed with creativity and precision — the process was smooth from start to finish..",
    name: "Shagufta Salman",
    org: "Mind Mechanics",
    website: "https://mindmechanicss.com", // 👈 add website link here
    img: "/ssalman.png",
  },
]
      ...
      <div className="mx-auto max-w-6xl text-center">
        ...
        <div className="grid gap-8 md:grid-cols-1 justify-items-center">
          {testimonials.map((t, i) => (
            <motion.div
              key={i}
              className="flex flex-col items-center rounded-2xl border border-border bg-card/60 p-6 shadow-lg max-w-sm"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: i * 0.2 }}
              ...
              <footer className="text-center">
                ...
                {t.website ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="block text-sm text-accent underline underline-offset-4 hover:opacity-80"
                  >
                    {t.org}
                  </a>
                ) : (

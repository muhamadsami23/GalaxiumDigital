    ...
    <main className="min-h-dvh bg-background text-foreground">
      ...
      >
        <FeatureRow
          ...
          imageQuery="custom web design 3d modern ui"
        ...
        <FeatureRow
          ...
          imageQuery="responsive design multiple devices 3d"
        ...
        <FeatureRow
          ...
          imageQuery="cms dashboard ui 3d"
          imageUrl="/cmsweb.png"
        />
        <FeatureRow
          ...
          imageQuery="api integration data flow 3d"
          imageUrl="/apiweb.png"
        />
        <FeatureRow
          ...
          imageQuery="cyber security shield 3d"

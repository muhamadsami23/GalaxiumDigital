import { Megaphone, Mail, Globe, BarChart2 } from "lucide-react"

const items = [
  { icon: Megaphone, label: "Social Media Marketing" },
  { icon: Globe, label: "Google & Meta Ads" },
  { icon: Mail, label: "Email & Cold Outreach" },
  { icon: BarChart2, label: "SEO & Analytics" },
]

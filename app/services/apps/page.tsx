...
// export default function AppDevelopmentPage() {
//   return (
//     <main className="relative z-10 min-h-dvh bg-background/90 backdrop-blur-sm text-foreground">
//       {/* Hero */}
//       <section aria-labelledby="hero-title" className="relative z-10 overflow-hidden">
//         <div className="mx-auto max-w-6xl px-4 py-20">
//           <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
...
//       <div
//         id="features"
//         className="mx-auto max-w-6xl px-4 py-16 space-y-36 relative z-10"
//       >
//         <FeatureRow
//           eyebrow="Cross-Platform Development"
//           title="One codebase, multiple platforms"
